...
GRAPHITE_SERVER=metrics.collab.net
GRAPHITE_PORT=2003
GRAPHITE_INTERVAL=300 # in seconds

if [ -f /var/ops/monitor/conf/graphite.conf ]; then
   source /var/ops/monitor/conf/graphite.conf
fi
